...
func (t tuiTheme) selected() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(lipgloss.Color("15")).Background(lipgloss.Color("63")).Bold(true)
}

func (t tuiTheme) panel() lipgloss.Style {
	return lipgloss.NewStyle().Border(lipgloss.RoundedBorder()).BorderForeground(lipgloss.Color("240")).Padding(0, 1)
}
...
func (t tuiTheme) ok() lipgloss.Style {
	return lipgloss.NewStyle().Foreground(lipgloss.Color("107")).Bold(true)
}
